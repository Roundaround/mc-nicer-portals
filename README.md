...
A handful of small portal improvements: quieter breaks, no piglin invasions, crying obsidian frames, and portals of any shape.

## Installing

Grab a build from [Modrinth](https://modrinth.com/mod/nicer-portals) or [CurseForge](https://www.curseforge.com/minecraft/mc-mods/nicer-portals). Fabric builds need [Fabric API](https://modrinth.com/mod/fabric-api).
...
Issues and pull requests are welcome at [the issue tracker](https://github.com/Roundaround/mc-nicer-portals/issues).
